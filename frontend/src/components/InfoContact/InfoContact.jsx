const InfoContact = () => {
  return (
    <div className="ps-[70px] pe-[70px] text-white mt-20">
      <div className="mt-1 flex justify-center space-x-12 rounded-full py-8 bg-gradient-to-r from-slate-900 via-violet-900 to-slate-900">
        ...
        <img src="./images/icons/telepon.svg" alt="telepon" className="ml-10"/>
          <div className="ml-4 text-md text-white-600">
